...
export default function SemesterScheduleHeader({credits, semesterInfo, setSemesters} : {credits: number, semesterInfo: CourseSemester, setSemesters: React.Dispatch<React.SetStateAction<CourseSemester[]>>}) {
    const classes = useStyles();
    const deleteSemester = () => {
        setSemesters((curSemesters) => curSemesters.filter((semester) => !(semester.year === semesterInfo.year && semester.semesterNumber === semesterInfo.semesterNumber)))
    }
    return(
